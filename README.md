...
To start with pre-processing and removing the bad contexts, please run `clean_data.py` file to generate a cleaned contexts file and to store the test data in json file `./data/cleaned_contexts.txt`. This script also stores the test data (questions, answers, and contexts):
